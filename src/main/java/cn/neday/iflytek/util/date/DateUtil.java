...
public class DateUtil {
    ...
    public static DateStyle getDateStyle(String date) {
        ...
        for (DateStyle style : DateStyle.values()) {
            ...
            Date dateTmp = getDateByDateStyle(date, style);
            if (dateTmp != null) {
    ...
    /**
     * 将dateString转换为Date(dateStyle格式)
     *
     * @param dateString 日期字符串
     * @param dateStyle  日期格式
     * @return 日期或者null
     */
    public static Date getDateByDateStyle(String dateString, DateStyle dateStyle) {
        Date date = null;
        if (dateString != null) {
            try {
                ParsePosition pos = new ParsePosition(0);
                date = getDateFormat(dateStyle.getValue()).parse(dateString, pos);
     ...
     * @return 当天0点时间戳
     */
    public static long getDayBeginTimestampLong() {
        Calendar calendar = Calendar.getInstance();
